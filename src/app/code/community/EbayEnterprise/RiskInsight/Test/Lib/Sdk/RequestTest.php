...
class EbayEnterprise_RiskInsight_Test_Lib_Sdk_RequestTest
	extends EcomDev_PHPUnit_Test_Case
{
	...
	{
		return new EbayEnterprise_RiskInsight_Sdk_Request();
	}
	...
	/**
	 * @param string $serializedDataFile - path to fixture file
	 * @expectedException EbayEnterprise_RiskInsight_Sdk_Exception_Invalid_Payload_Exception
