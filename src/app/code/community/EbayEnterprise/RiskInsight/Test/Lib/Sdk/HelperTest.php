...
class EbayEnterprise_RiskInsight_Test_Lib_Sdk_HelperTest
	extends EcomDev_PHPUnit_Test_Case
{

	/** @var EbayEnterprise_RiskInsight_Sdk_IHelper */
	protected $_helper;
	 ...
	 *
	 * @return EbayEnterprise_RiskInsight_Sdk_IHelper
	 */
	protected function _createNewHelper()
	{
		return new EbayEnterprise_RiskInsight_Sdk_Helper();
	}
	 ...
	 * EbayEnterprise_RiskInsight_Sdk_Helper::getPayloadAsDoc method.
	 *
	 * @expectedException EbayEnterprise_RiskInsight_Sdk_Exception_Invalid_Xml_Exception
	 */
