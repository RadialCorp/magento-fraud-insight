...
class EbayEnterprise_RiskInsight_Test_Model_Cron_FeedbackTest
	extends EcomDev_PHPUnit_Test_Case
{
	...
	/**
	 * Test that when the method ebayenterprise_riskinsight/cron_feedback::process()
	 * is invoked, it will call EbayEnterprise_RiskInsight_Helper_Data::getFeedbackOrderCollection() method
	 * to get a collection of risk insight object and then passed this collection of risk insight object to
	 * the method ebayenterprise_riskinsight/cron_feedback::_processFeebackOrderCollection() method and
	 * the method ebayenterprise_riskinsight/cron_feedback::process() will return itself.
	 */
	public function testCronFeedbackOrderProcess()
	{
		$riskInsightCollection = $this->_buildFeedbackOrderCollection();
		$helper = $this->getHelperMock('ebayenterprise_riskinsight/data', array('getFeedbackOrderCollection'));
		$helper->expects($this->once())
			->method('getFeedbackOrderCollection')
			->will($this->returnValue($riskInsightCollection));

		$feedback = $this->getModelMockBuilder('ebayenterprise_riskinsight/cron_feedback')
	...
	/**
	 * Test that when the method ebayenterprise_riskinsight/cron_feedback::_processFeebackOrderCollection()
	 * is invoked, it will be passed a EbayEnterprise_RiskInsight_Model_Resource_Risk_Insight_Collection object
	 * as its parameter. It will call EbayEnterprise_RiskInsight_Helper_Data::getOrderCollectionByIncrementIds()
	 ...
	 * EbayEnterprise_RiskInsight_Helper_Data::isOrderInAStateToSendFeedback() passing in the order object.
	 * The EbayEnterprise_RiskInsight_Helper_Data::isOrderInAStateToSendFeedback() method will return true
	 * if the state is either complete or cancel. Then it will proceed to called the method
	 * ebayenterprise_riskinsight/cron_feedback::_processOrderFeedback passing in the risk insight object and
	...
	public function testProcessFeebackOrderCollection()
	{
		...
		$riskInsightCollection = Mage::getResourceModel('ebayenterprise_riskinsight/risk_insight_collection');
	...
	/**
	 * Test that when the method ebayenterprise_riskinsight/cron_feedback::_processOrderFeedback
	 * is invoked, it will be passed a EbayEnterprise_RiskInsight_Model_Risk_Insight object and
	 * a Mage_Sales_Model_Order object as its parameters. It will instantiated a
	 * ebayenterprise_riskinsight/send_feedback object passing in an array with key 'order' mapped
	 * to a sales/order object and another key 'insight' mapped to a ebayenterprise_riskinsight/risk_insight
	 * object. Then, it will invoke ebayenterprise_riskinsight/send_feedback::send method. Finally,
	...
	public function testProcessOrderFeedback()
	{
		...
		$feedback = Mage::getModel('ebayenterprise_riskinsight/cron_feedback');
