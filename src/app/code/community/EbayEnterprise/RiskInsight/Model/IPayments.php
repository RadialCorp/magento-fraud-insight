...
interface EbayEnterprise_RiskInsight_Model_IPayments extends Countable, Iterator, ArrayAccess, EbayEnterprise_RiskInsight_Model_IIterable
{
	const PAYMENT_MODEL = 'ebayenterprise_riskinsight/payment';
