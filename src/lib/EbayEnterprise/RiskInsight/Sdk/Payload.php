...
abstract class EbayEnterprise_RiskInsight_Sdk_Payload
	implements EbayEnterprise_RiskInsight_Sdk_IPayload
{
	/** @var EbayEnterprise_RiskInsight_Sdk_Xsd_Validator */
	 ...
	 *                          - 'helper' => EbayEnterprise_RiskInsight_Sdk_Helper
	 */
	public function __construct(array $initParams=array())
	{
		$this->_helper = $this->_checkHelperClassType(
			$this->_nullCoalesce($initParams, 'helper', $this->_getNewInstance('EbayEnterprise_RiskInsight_Sdk_Helper'))
		);
	}
	 ...
	 * @return EbayEnterprise_RiskInsight_Sdk_Helper
	 */
	protected function _checkHelperClassType(EbayEnterprise_RiskInsight_Sdk_Helper $helper)
	{
		return $helper;
	}
	 ...
	 *
	 * @throws EbayEnterprise_RiskInsight_Sdk_Exception_Invalid_Payload_Exception
	 * @param  string
	 * @return $this
	 */
	...
	protected function _deserializeSubpayloadExtractionPaths(DOMXPath $xpath)
	{
		foreach ($this->_subpayloadExtractionPaths as $setter => $path) {
			...
			if ($foundNode && $this->$getter() instanceof EbayEnterprise_RiskInsight_Sdk_IPayload) {
	 ...
	 *
	 * @return EbayEnterprise_RiskInsight_Sdk_Xsd_Validator
	 */
	protected function _getXsdValidator()
	{
		if (!$this->_schemaValidator) {
			$this->_schemaValidator = $this->_buildPayloadForModel('EbayEnterprise_RiskInsight_Sdk_Xsd_Validator');
		}
	...
	/**
	 * Build a new EbayEnterprise_RiskInsight_Sdk_IPayload for the given interface.
	 *
	 * @param  strings
