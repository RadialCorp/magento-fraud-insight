 ...
 * @codeCoverageIgnore
 */
class EbayEnterprise_RiskInsight_Sdk_Api
	implements EbayEnterprise_RiskInsight_Sdk_IApi
{
	/** @var EbayEnterprise_RiskInsight_Sdk_IConfig */
	protected $_config;
	...
	/** @var EbayEnterprise_RiskInsight_Sdk_Helper_Config */
	 ...
	 *
	 * @param EbayEnterprise_RiskInsight_Sdk_Config
	 */
	public function __construct(EbayEnterprise_RiskInsight_Sdk_Config $config)
	{
		$this->_config = $config;
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_IApi::setRequestBody()
	 */
	public function setRequestBody(EbayEnterprise_RiskInsight_Sdk_IPayload $payload)
	{
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_IApi::send()
	 */
	public function send()
	{
		...
		try {
			if ($this->_sendRequest() === false) {
				...
				throw Mage::exception('EbayEnterprise_RiskInsight_Sdk_Exception_Network_Error', $message);
			}
			...
			throw Mage::exception('EbayEnterprise_RiskInsight_Sdk_Exception_Network_Error', $e->getMessage());
		}
	...
	protected function _deserializeResponse($responseData)
	{
		...
		} catch (EbayEnterprise_RiskInsight_Sdk_Exception_Invalid_Payload_Exception $e) {
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_IApi::getRequestBody()
	 */
	public function getRequestBody()
	{
		...
		} catch (EbayEnterprise_RiskInsight_Sdk_Exception_Unsupported_Payload_Exception $e) {
			throw Mage::exception('EbayEnterprise_RiskInsight_Sdk_Exception_Unsupported_Operation', '');
		}
		return $this->_requestPayload;
	}

	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_IApi::getResponseBody()
	 */
	 ...
	 *
	 * @return boolean
	 * @throws EbayEnterprise_RiskInsight_Sdk_Exception_Unsupported_Http_Action_Exception
	 */
	protected function _sendRequest()
	{
		...
		if (!method_exists($this, $httpMethod)) {
			throw Mage::exception(
				'EbayEnterprise_RiskInsight_Sdk_Exception_Unsupported_Http_Action',
