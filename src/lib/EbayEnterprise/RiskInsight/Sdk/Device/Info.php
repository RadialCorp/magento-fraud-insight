...
class EbayEnterprise_RiskInsight_Sdk_Device_Info
	extends EbayEnterprise_RiskInsight_Sdk_Payload
	implements EbayEnterprise_RiskInsight_Sdk_Device_IInfo
{
	/** @var string */
	protected $_deviceIP;
	/** @var EbayEnterprise_RiskInsight_Sdk_Http_Headers */
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_Device_IInfo::getDeviceIP()
	 */
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_Device_IInfo::setDeviceIP()
	 */
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_Device_IInfo::getHttpHeaders()
	 */
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_Device_IInfo::setHttpHeaders()
	 */
	public function setHttpHeaders(EbayEnterprise_RiskInsight_Sdk_Http_Headers $httpHeaders)
	{
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_Payload::setHttpHeaders()
	 */
