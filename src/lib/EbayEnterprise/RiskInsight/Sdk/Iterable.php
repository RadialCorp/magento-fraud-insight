...
abstract class EbayEnterprise_RiskInsight_Sdk_Iterable
	extends SPLObjectStorage
	implements EbayEnterprise_RiskInsight_Sdk_IIterable
{
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_IPayload::serialize()
	 */
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_IPayload::deserialize()
	 */
