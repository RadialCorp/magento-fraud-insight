...
class EbayEnterprise_RiskInsight_Sdk_Total
	extends EbayEnterprise_RiskInsight_Sdk_Payload
	implements EbayEnterprise_RiskInsight_Sdk_ITotal
{
	/** @var EbayEnterprise_RiskInsight_Sdk_Cost_Totals */
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_ITotal::getCostTotals()
	 */
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_ITotal::setCostTotals()
	 */
