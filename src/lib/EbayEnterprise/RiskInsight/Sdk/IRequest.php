...
interface EbayEnterprise_RiskInsight_Sdk_IRequest extends EbayEnterprise_RiskInsight_Sdk_Payload_ITop
{
	...
	const ORDER_MODEL ='EbayEnterprise_RiskInsight_Sdk_Order';
	 ...
	 *
	 * @return EbayEnterprise_RiskInsight_Sdk_IOrder
	 */
