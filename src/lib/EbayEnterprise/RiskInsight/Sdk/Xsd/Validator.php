...
class EbayEnterprise_RiskInsight_Sdk_Xsd_Validator
	implements EbayEnterprise_RiskInsight_Sdk_Schema_IValidator
{
	/**
	 ...
	 * @return self
	 * @throws EbayEnterprise_RiskInsight_Sdk_Exception_Invalid_Payload_Exception If the XML does not pass XSD schema validation.
	 */
	public function validate($xmlString, $schemaFile=null)
	{
		...
		if (!$isValid) {
			throw Mage::exception('EbayEnterprise_RiskInsight_Sdk_Exception_Invalid_Payload', $this->_formatErrors($errors));
		}
		return $this;
	}
