...
interface EbayEnterprise_RiskInsight_Sdk_IOrder extends EbayEnterprise_RiskInsight_Sdk_IPayload
{
	const ROOT_NODE = 'Order';
	const XML_NS = 'http://schema.gsicommerce.com/risk/insight/1.0/';
	const SHIPPING_LIST_MODEL ='EbayEnterprise_RiskInsight_Sdk_Shipping_List';
	const LINE_ITEMS_MODEL ='EbayEnterprise_RiskInsight_Sdk_Line_Items';
	const PAYMENTS_MODEL ='EbayEnterprise_RiskInsight_Sdk_Payments';
	const TOTAL_MODEL ='EbayEnterprise_RiskInsight_Sdk_Total';
	const DEVICE_INFO_MODEL ='EbayEnterprise_RiskInsight_Sdk_Device_Info';
	...
	/**
	 * @return EbayEnterprise_RiskInsight_Sdk_Shipping_IList
	 */
	...
	/**
	 * @return EbayEnterprise_RiskInsight_Sdk_Line_IItems
	 */
	...
	/**
	 * @return EbayEnterprise_RiskInsight_Sdk_IPayments
	 */
	 ...
	 * @return self
	 */
	public function setFormOfPayments(EbayEnterprise_RiskInsight_Sdk_IPayments $payments);

	/**
	 * @return EbayEnterprise_RiskInsight_Sdk_ITotal
	 */
	...
	/**
	 * @return EbayEnterprise_RiskInsight_Sdk_Device_IInfo
	 */
