...
class EbayEnterprise_RiskInsight_Sdk_Transaction_Response
	extends EbayEnterprise_RiskInsight_Sdk_Payload
	implements EbayEnterprise_RiskInsight_Sdk_Transaction_IResponse
{
	/** @var string */
	protected $_response;
	/** @var string */
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_Transaction_IResponse::getResponse()
	 */
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_Transaction_IResponse::setResponse()
	 */
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_Transaction_IResponse::getResponseType()
	 */
	...
	/**
	 * @see EbayEnterprise_RiskInsight_Sdk_Transaction_IResponse::setResponseType()
	 */
